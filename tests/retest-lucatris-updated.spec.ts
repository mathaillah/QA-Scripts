...
test('Retest Lucatris Failed Users with updated emails', async ({ page, context }) => {
  test.setTimeout(600000); // 10 minutes

  // Updated Lucatris failed users from results file
  const failedUsers: FailedUser[] = [
    ...
    { name: 'AGUNG NUGROHO', email: 'agung.nugroho@radiant-utama.com', branch: 'Jakarta' },
    { name: 'AKHIR PURWANTO', email: 'akhirpurwanto@gmail.com', branch: 'Jakarta' },
    ...
    { name: 'RAHMAT YULI HARNANTO', email: 'harnantorahmat@gmail.com', branch: 'Jakarta' },
  ...
  console.log(`\n========================================`);
  console.log(`RETEST LUCATRIS FAILED USERS (UPDATED)`);
  console.log(`========================================`);
